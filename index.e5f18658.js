...
function isDateValid(now, date) {
    ...
    if (isNaN(date.getDate()) || !isDateCorrect) {
        addInvalidDateValidation(_constantsJs.VALIDATION_ERROR_INCORRECT_DATE);
        return {
            success: false
        };
    } else if (!(0, _dateFns.isPast)(date)) {
        addInvalidDateValidation(_constantsJs.VALIDATION_ERROR_DATE_IN_THE_FUTURE);
        return {
            success: false
        };
    } else {
...
function ValidateEveryInput(dayId, monthId, yearId, now) {
    ...
    isAnyValidFlag = isInputValid(isDayCorrect, !dayId.value, dayId, _constantsJs.VALIDATION_ERROR_INCORRECT_DAY) && isAnyValidFlag;
    isAnyValidFlag = isInputValid(isMonthCorrect, !monthId.value, monthId, _constantsJs.VALIDATION_ERROR_INCORRECT_MONTH) && isAnyValidFlag;
    isAnyValidFlag = isInputValid(isYearCorrect, !yearId.value, yearId, _constantsJs.VALIDATION_ERROR_INCORRECT_YEAR) && isAnyValidFlag;
    isAnyValidFlag = isInputValid(isYearInThePast, !yearId.value, yearId, _constantsJs.VALIDATION_ERROR_DATE_IN_THE_FUTURE) && isAnyValidFlag;
    return {
...
function addInvalidDateValidation(message) {
    ...
    addValidationMessageAndStyles(monthId, _constantsJs.EMPTY_STRING);
    addValidationMessageAndStyles(yearId, _constantsJs.EMPTY_STRING);
}
function isInputValid(isInputCorrect, isInputNull, input, validationMessage) {
    if (!isInputCorrect) {
        if (isInputNull) {
            addValidationMessageAndStyles(input, _constantsJs.VALIDATION_ERROR_FIELD_REQUIRED);
            return false;
        } else {
...
function removeValidationMessagesAndStyles(element) {
    element.style.borderColor = _constantsJs.EMPTY_STRING;
    if (element.nextElementSibling) element.nextElementSibling.textContent = _constantsJs.EMPTY_STRING;
    if (element.previousElementSibling) element.previousElementSibling.style.color = _constantsJs.EMPTY_STRING;
}
...
function calculateAge(now, date) {
    ...
    document.getElementById("yearsResultId").textContent = years + _constantsJs.SPACE;
    document.getElementById("monthsResultId").textContent = months + _constantsJs.SPACE;
    document.getElementById("daysResultId").textContent = days + _constantsJs.SPACE;
}

},{"./constants.js":"itKcQ","date-fns":"dU215"}],"itKcQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "VALIDATION_ERROR_FIELD_REQUIRED", ()=>VALIDATION_ERROR_FIELD_REQUIRED);
parcelHelpers.export(exports, "VALIDATION_ERROR_INCORRECT_DATE", ()=>VALIDATION_ERROR_INCORRECT_DATE);
parcelHelpers.export(exports, "VALIDATION_ERROR_INCORRECT_DAY", ()=>VALIDATION_ERROR_INCORRECT_DAY);
parcelHelpers.export(exports, "VALIDATION_ERROR_INCORRECT_MONTH", ()=>VALIDATION_ERROR_INCORRECT_MONTH);
parcelHelpers.export(exports, "VALIDATION_ERROR_INCORRECT_YEAR", ()=>VALIDATION_ERROR_INCORRECT_YEAR);
parcelHelpers.export(exports, "VALIDATION_ERROR_DATE_IN_THE_FUTURE", ()=>VALIDATION_ERROR_DATE_IN_THE_FUTURE);
parcelHelpers.export(exports, "EMPTY_STRING", ()=>EMPTY_STRING);
parcelHelpers.export(exports, "SPACE", ()=>SPACE);
const VALIDATION_ERROR_FIELD_REQUIRED = "This field is required";
const VALIDATION_ERROR_INCORRECT_DATE = "The date is incorrect";
const VALIDATION_ERROR_INCORRECT_DAY = "Must be a valid day";
const VALIDATION_ERROR_INCORRECT_MONTH = "Must be a valid month";
const VALIDATION_ERROR_INCORRECT_YEAR = "Must be a valid year";
const VALIDATION_ERROR_DATE_IN_THE_FUTURE = "Must be in the past";
const EMPTY_STRING = "";
const SPACE = " ";
...
},{"387b0aecfe84b867":"1vXXw"}]},["7ENHu","1Jxk5"], "1Jxk5", "parcelRequire0a17")
